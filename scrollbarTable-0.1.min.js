...
child=parent.children();width=child.innerWidth()-child.height(99).innerWidth();parent.remove();}
return width;}());
var cols=[];
$t.find('tr:first th,tr:first td').each(function(){cols.push($(this).width());});
...
$t.find('tr:first th,tr:first td').each(function(i){$(this).attr('width',cols[i]);});
var $wrap=$('<div>');
if(h<o.height)o.height=$h;
